...
Feature: laptop & Notebooks
  ...
  Scenario: Add and Remove a Macbook from the cart
    ...
    Then User should see a success message "Success: You have added MacBook to your shopping cart!"
  ...
  Scenario: Product comparison
    ...
    And User clicks on product comparison icon on 'MacBook Air'
  ...
  Scenario: Adding an item to wish list
    And User clicks on heart icon to add Sony Vaio laptop to wish list
    Then User should see a sucess message 'You must login or create an account to save Sony VAIO to your wish list!'
